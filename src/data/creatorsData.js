...
export const directors = [
    {
        ...
        bioEn: 'A renowned Thai film director who created a phenomenon of action movies that brought Muay Thai to the eyes of global audiences. Known for legendary works like <strong>Ong-Bak</strong> and <strong>Tom-Yum-Goong</strong>, generating over 1.4 billion baht worldwide. He played a key role in reviving Thai action cinema and inspiring new generations of directors internationally, with over 20 films directed.',
        works: 'องค์บาก (2546), ต้มยำกุ้ง (2548), ช็อคโกแลต (2551), ต้มยำกุ้ง 2 (2556), ลูกทุ่ง ซิกเนเจอร์ (2559)',
        worksEn: 'Ong-Bak (2003), Tom-Yum-Goong (2005), Chocolate (2008), Tom-Yum-Goong 2 (2013), Looktung Signature (2016)'
    },
    {
        img: director2,
        ...
        bioEn: 'A Thai film and series director who grew from behind-the-scenes work. Known for quality dramas like <strong>The Judgement (Ai-Fak)</strong> and unique comedy-dramas like <strong>Mid Road Gang (Ma Mha 4 Kha Krub)</strong>. Currently serves as Managing Director of Fah Studios under GMM Grammy.',
        ...
        worksEn: 'Sunset at Chaophraya (1995), Red Bike Story (1997), The Judgement (2004), Mid Road Gang (2007), For You (2016), Prom Mai Dai Likit (2018), Nyctophobia (2019)'
    },
    {
        img: director3,
        name: 'บัณฑิต ทองดี',
        ...
        bioEn: 'A long-standing Thai film director covering various genres including drama, romance, horror, and country music films. Known for <strong>Pai in Love</strong> and <strong>The Moon (Pumpuang)</strong>. Currently serves as the President of the Thai Film Directors Association.',
        works: 'มนุษย์เหล็กไหล (2549), ปายอินเลิฟ (2552), พุ่มพวง (2554), ฝัน-หวาน-อาย-จูบ (2551), รักนี้หัวใจมีครีบ (2555), ดับแสงรวี (2566)',
        worksEn: 'Mercury Man (2006), Pai in Love (2009), The Moon (2011), 4 Romances (2008), Ruk Nee Hua Jai Mee Krib (2012), After Sundown (2023)'
    },
    {
        img: director4,
        name: 'ศิวาภรณ์ พงษ์สุวรรณ',
        role: 'Sceenwriter / Producer',
        bio: 'ศิวาภรณ์ พงษ์สุวรรณ เป็นนักเขียนบทและผู้กำกับภาพยนตร์ไทยที่ทำงานอยู่กับภาพยนตร์แนวคอมเมดี้และดราม่าเป็นหลัก เริ่มต้นจากการเขียนบทในช่วงต้นทศวรรษ 2000 และค่อย ๆ ขยายบทบาทสู่การกำกับและการดูแลภาพรวมของงานผลิต ด้วยแนวทางการเล่าเรื่องที่เรียบง่าย เป็นกันเอง และผูกโยงอารมณ์ขันเข้ากับชีวิตประจำวันของคนไทย ผลงานอย่าง <strong>สยิว</strong> ซึ่งเป็นงานกำกับเรื่องแรก ทำให้เป็นที่รู้จักในวงการภาพยนตร์อิสระยุคนั้น ขณะที่บทภาพยนตร์อย่าง <strong>Fake โกหก...</strong>ทั้งเพ และ เอ็กซ์แมน แฟนพันธุ์เอ็กซ์ แสดงให้เห็นความถนัดในการเขียนบทคอมเมดี้ที่อิงจากสถานการณ์ใกล้ตัวและความสัมพันธ์ของผู้คน นอกจากนี้ทำหน้าที่โปรดิวเซอร์ ในภาพยนตร์ <strong>บองสรันโอน: คน รัก ผี </strong>ซึ่งเป็นงานที่ผสมผสานความเชื่อ เรื่องผี และอารมณ์แบบโรแมนติกคอมเมดี้ได้อย่างลงตัวตลอดเส้นทางการทำงาน ศิวาภรณ์มุ่งเล่าเรื่องที่จริงใจ ไม่ซับซ้อนเกินจำเป็น และเปิดพื้นที่ให้มุมมองของผู้หญิงได้ปรากฏอย่างเป็นธรรมชาติในภาพยนตร์ไทย',
        bioEn: 'Sivaporn Pongsuwan is a Thai screenwriter and director focusing on comedy and drama. Known for her directorial debut <strong>Sayew</strong> and screenplays like <strong>Fake</strong> and <strong>X-Man</strong>. She also produced <strong>Bongsrol: Love/Ghost/Story</strong>.',
        works: 'สยิว (2546), Fake โกหก...ทั้งเพ (2546), เอ็กซ์แมน แฟนพันธุ์เอ็กซ์ (2547), บองสรันโอน: คน รัก ผี (2558)',
        worksEn: 'Sayew (2003), Fake (2003), X-Man (2004), Bongsrol (2015)'
    },
    {
        img: director5,
        name: 'ราเชนทร์ ลิ้มตระกูล',
        role: 'Director',
        bio: 'ผู้กำกับภาพยนตร์ไทยที่เติบโตมาจากสายมิวสิกวิดีโอในช่วงยุค 90s ก่อนก้าวสู่การกำกับภาพยนตร์เรื่องแรกในปี พ.ศ. 2538 ผลงานในแนวโรแมนติกและแอ็กชัน โดยให้ความสำคัญกับอารมณ์ของตัวละครและการเล่าเรื่องที่เข้ากับบริบทยุคสมัย นอกจากบทบาทผู้กำกับแล้ว ยังทำงานในฐานะโปรดิวเซอร์ และมีส่วนสำคัญในการขับเคลื่อนวงการภาพยนตร์ไทยมาอย่างต่อเนื่อง เป็นที่รู้จักอย่างกว้างขวางจากภาพยนตร์ <strong>โลกทั้งใบให้นายคนเดียว</strong> ซึ่งกลายเป็นภาพยนตร์รักคลาสสิกของไทย และสร้างชื่อเสียงให้เขาในฐานะผู้กำกับรุ่นใหม่ของยุคนั้น ต่อมาได้กลับมาสร้างผลงานที่เข้าถึงผู้ชมรุ่นใหม่ผ่าน <strong>ฝัน-หวาน-อาย-จูบ</strong> และภาพยนตร์แอ็กชัน <strong>จีจ้า ดื้อสวยดุ</strong> ที่ช่วยเปิดพื้นที่ให้ภาพลักษณ์นักแสดงหญิงในหนังแอ็กชันไทย ในฐานะโปรดิวเซอร์มีผลงานที่ประสบความสำเร็จหลายเรื่องเช่น<strong> มือปืน/โลก/พระ/จัน </strong>ซึ่งสร้างรายได้สูง และโปรเจกต์สำคัญอื่น ๆ ที่ตอกย้ำบทบาทของเขาทั้งในเชิงสร้างสรรค์และเชิงอุตสาหกรรม',
        bioEn: 'A Thai film director who started from music videos in the 90s. Famous for the classic romance <strong>Romantic Blue (Loke Tung Bai Hai Nai Kon Diew)</strong>. Also directed <strong>Raging Phoenix (Jeeja Due Suay Doo)</strong> and produced hits like <strong>Killer Tattoo</strong>.',
        works: 'โลกทั้งใบให้นายคนเดียว (2538), มือปืน/โลก/พระ/จัน (2544), ฝัน-หวาน-อาย-จูบ (2551), จีจ้า ดื้อสวยดุ (2552)',
        worksEn: 'Romantic Blue (1995), Killer Tattoo (2001), 4 Romances (2008), Raging Phoenix (2009)'
    },
    {
        img: director6,
        ...
        bioEn: 'Indie Thai film director focusing on life, feelings, and relationships. Known for <strong>The Unreasonable Man</strong> and <strong>Fantasy Friend</strong>. Also involved in screenwriting including <strong>Bongsrol</strong>.',
        works: 'Fantasy Friend (2556), The Unreasonable Man – ไม่รู้…มันคืออะไร แต่ชอบ (2557), บองสรันโอน: คน รัก ผี (2558)',
        worksEn: 'Fantasy Friend (2013), The Unreasonable Man (2014), Bongsrol (2015)'
    },
    {
        img: director7,
        ...
        bioEn: 'Thai screenwriter known for works in film, series, TV, and stage plays. Recognized for the stage play <strong>Tea Box</strong>. His works like <strong>Doctor Forever</strong> and <strong>Debt Therapy Company</strong> reflect social issues.',
        works: 'อวสานมนุษย์เงินเดือน (2564), บริษัทบำบัดหนี้ (2564), Tea Box ชายชรากับหมาบ้า (2564), หมอตลอดกาล (2567)',
        worksEn: 'The End of Salaryman (2021), Debt Therapy Company (2021), Tea Box (2021), Doctor Forever (2024)'
    }
];
