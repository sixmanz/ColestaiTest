        ...
        <div className="min-h-screen bg-black flex items-center justify-center relative overflow-hidden p-6">
            ...
            <div className="relative z-10 w-full max-w-md">
                <Link to="/login" className="inline-flex items-center text-gray-400 hover:text-white mb-8 transition-colors">
                    <ArrowLeft size={20} className="mr-2" /> {t('auth_back_login')}
                </Link>
                ...
                >
                    {!isSubmitted ? (
                        <>
                            <div className="mb-8">
                                <h1 className="text-3xl font-display font-bold text-white mb-2">{t('auth_forgot_title')}</h1>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div>
                                    <label className="block text-sm font-medium text-gray-300 mb-2">{t('auth_email_placeholder')}</label>
                                ...
                                >
                                    {isSubmitting ? <Loader className="animate-spin" /> : t('auth_send_reset')}
                                </button>
                            </form>
                        </>
                    ) : (
                        <div className="text-center py-8">
                            ...
                            <h2 className="text-2xl font-bold text-white mb-4">{t('auth_check_email_title')}</h2>
                            <p className="text-gray-400 text-sm mb-8">
                                {t('auth_check_email_desc')} <br />
